...
- DBA-разработчики: SQL, Oracle, Java, Ruby, Git.
...
- Команды, которые хотят единые правила работы с Cursor, Claude Code, Codex, ChatGPT и похожими инструментами.

## Главная идея

Плохой вайбкодинг: "сделай мне приложение", потом копируем код и надеемся, что работает.

Deepcoding: сначала понимаем задачу, даем ИИ правильный контекст, работаем маленькими шагами, проверяем код тестами, ревью и линтерами, а сложные задачи раскладываем на роли: planner, worker, tester, reviewer.
...
- читать и проверять AI-generated diff;
...
- строить AI-harness для команды.

## Минимальный финальный проект

В конце курса каждый участник собирает учебный проект с AI-инфраструктурой:
